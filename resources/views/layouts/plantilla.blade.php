...
<body id="page-top">
    ...
    <div class="sidebar-brand-icon">
        <img src="img/Logosky.png" alt="Logo de la empresa" style="width: 180px; height: 150px; object-fit: contain; float: right; transform: rotate(0deg); transform-origin: top right;">
    </div>
</a>
...
<!-- Nav Item - Utilities Collapse Menu -->
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseEmpresas" aria-expanded="true"
    ...
    <div id="collapseEmpresas" class="collapse" aria-labelledby="headingEmpresas" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('empresa/create')}}" href="utilities-border.html">Insertar
                empresas</a>
...
<li class="nav-item">
    ...
    <div id="collapseClientes" class="collapse" aria-labelledby="headingClientes" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones:</h6>
            <a class="collapse-item" href="{{ url('cliente_particular')}}" href="utilities-color.html">Cliente particular</a>
            <a class="collapse-item" href="{{ url('cliente_empresarial')}}" href="utilities-border.html">Cliente
                empresarial</a>
...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTecnicos" aria-expanded="true"
        aria-controls="collapseTecnicos">
        <i class="fas fa-fw fa-folder"></i>
        <span>Tecnicos</span>
    </a>
    <div id="collapseTecnicos" class="collapse" aria-labelledby="headingTecnicos" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones:</h6>
            <a class="collapse-item" href="{{ url('tecnico')}}" href="utilities-color.html">Tecnicos</a>
